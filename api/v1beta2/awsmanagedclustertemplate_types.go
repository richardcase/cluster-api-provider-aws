...
// AWSManagedClusterTemplate is the schema for Amazon EKS based Kubernetes Cluster Templates.
...
// AWSManagedClusterTemplateList contains a list of AWSManagedClusterTemplate.
